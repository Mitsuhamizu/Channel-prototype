...
class Test < Minitest::Test
  ...
  #   simulation("Receiver_gather_insufficient_1_stage.json")
  # end

  # def test_receiver_gather_insufficient_2_stage()
  #   simulation("Receiver_gather_insufficient_2_stage.json")
  # end

  # def test_receiver_gather_success_1_stage()
  #   simulation("Receiver_gather_success_1_stage.json")
  # end

  # def test_receiver_gather_success_2_stage()
  #   simulation("Receiver_gather_success_2_stage.json")
  # end

  # sender

  def test_sender_gather_insufficient_1_stage()
    simulation("Sender_gather_insufficient_1_stage.json")
  end

  def test_sender_gather_insufficient_2_stage()
    simulation("Sender_gather_insufficient_2_stage.json")
  end

  def test_sender_gather_success_1_stage()
    simulation("Sender_gather_success_1_stage.json")
  end

  def test_sender_gather_success_2_stage()
    simulation("Sender_gather_success_2_stage.json")
  end
end
