...
class Step5 < Minitest::Test
  def establish_step5(file_name)
    begin
      ...
      bot.send_msg(ip_B, listen_port_B, [msg_1, msg_3, msg_5])
      sleep(2)
  ...
  def test_success()
    establish_step5("test_step5_success.json")
  end

  def test_fund_tx_modified()
    establish_step5("test_step5_fund_tx_modified.json")
  end
