...
wallet = CKB::Wallet.from_hex(@api, "0x82dede298f916ced53bf5aa87cea8a7e44e8898eaedcff96606579f7bf84d99d") # 新钱包
wallet2 = CKB::Wallet.from_hex(@api, "0xd986d7bf901e50368cbe565f239c224934cd554805357338abcef177efadc08d") # 新钱包

puts wallet.get_balance()
puts wallet2.get_balance()
